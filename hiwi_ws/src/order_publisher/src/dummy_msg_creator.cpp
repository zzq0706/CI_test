...
OrderMsg::OrderMsg(vda5050_msgs::Order &msg, int last_released_node, std::string& last_released_nodeId)
{
    _msg = msg;
...
void OrderMsg::create_edges(int node_num, int node_released_num)
{
    ...
    for (int i = 0; i < (node_num - 1); i++)
    {
        ...
        subedge.edgeDescription = "Edge connecting 9b5d075a-8757-4002-929d-e245c624881b to 6f61c844-e3d7-4018-85bf-c9d867fdd3d4";
...
void OrderMsg::create_example_order(int new_headerId,
...
vda5050_msgs::Order OrderMsg::get_msg()
{
    return this->_msg;
}
